...
class BaseDataset(object):
	...
	def train_test_split(self):
		return train_test_split(self.X, self.y, test_size=0.3, random_state=self.seed,shuffle=True)
	...
	def plot_dataset(self):
		...
		plt.scatter(self.X_train,self.y_train,label='training')
		plt.scatter(self.X_test,self.y_test,label='testing')
		plt.legend()
		#fig.show()
