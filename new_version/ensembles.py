...
class BootstrapEnsemble(object):    
    def __init__(self,ensemble=None,num_features = None,num_epochs=10,num_ensembles=5):
...
class BootstrapThroughTimeBobStrap(BootstrapEnsemble):
    ...
    def __init__(self,num_features = None,num_epochs = 1,num_models=10,model_name='copynetwork'):
